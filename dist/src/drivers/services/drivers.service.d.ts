...
import { SubscribeDriverDto, UpdateDriverProfileDto, UpdateDriverLocationDto, DriverStatsResponseDto } from '../dto/driver.dto';
export declare class DriversService {
    private prisma;
    private config;
    private supabase;
    private readonly logger;
    private readonly dailyFeeAmount;
    private readonly graceHours;
    private realtimeGateway;
    constructor(prisma: PrismaService, config: ConfigService, supabase: SupabaseService);
    ...
    getStats(userId: string): Promise<DriverStatsResponseDto>;
    private calculateSubscriptionStreak;
